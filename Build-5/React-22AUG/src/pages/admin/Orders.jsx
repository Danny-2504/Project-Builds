...
const Orders = () => {
  ...
  return (
   ...
   <div>
   <div className="row mt-5" style={{paddingLeft:'70px'}}>
    ...
    <div class="card paint-card cardx" style={{width:"100%"}}>
      <div class="card-body">
        <h4 class="form-signin-heading text-center">Order Details({orderContent})</h4>
