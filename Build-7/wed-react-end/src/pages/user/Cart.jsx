...
const loginUser=useSelector((u) => u.user);
  ...
  const orderPage = (e) => {
    ...
    if (pymtType === "COD") {
      ...
      axios.post(url,JSON.stringify({amt:tot,info:"order_request"}), 
        {headers: {
     ...
     console.log(response)
      if(response.data.status=='created'){
       ...
       // INR. Hence, 50000 refers to 50000 paise
         ...
         "image": "https://uploads-ssl.webflow.com/61e26cac44a5f4e78e0af5bd/622963675ca27bdc04aae9d7_1640135518357.Booktopia_logo_visa.jpg",
   ...
   const updatePayment=(payment_id,order_id,status)=>{
     ...
     axios.post(url,JSON.stringify({payment_id:payment_id,order_id:order_id,status:status}),   {headers: {
       'Content-Type': 'application/json',
   }})
   .then(response=>{
            ...
            <div className="card paint-card">
              <div className="card-body">
                ...
                <p className="fw-bold">
                  ...
                  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                  ₹&nbsp;{parseFloat(tot.toFixed(2))+60+30}
                  <br />
