...
const Orders = () => {
 ...
 const user= useSelector((u)=>u.user)
  ...
  return (
    ...
    <div >
      <div className="container mt-10" style={{marginTop:'20px'}}>
      <div className="card paint-card">
        ...
        <button type="button" className="btn btn-danger mx-2" style={{ width: '150px', alignContent:'flex-end',alignContent:'flex-end'}}  onClick={()=>{setOrderContent("Order Recieved")}} >Pending Orders</button>
        </div>
        </div>
